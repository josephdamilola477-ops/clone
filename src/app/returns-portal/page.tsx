      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="max-w-xl mx-auto">
          ...
          <div className="prose dark:prose-invert mt-12 mx-auto">
            ...
            <p>
              We want you to be completely satisfied with your purchase. If not, we're here to help.
            </p>
            <ul>
              <li>You can return items within 30 days of the delivery date.</li>
              <li>Items must be in original condition: unused, in the original packaging, and with all tags attached.</li>
