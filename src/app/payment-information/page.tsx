      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose dark:prose-invert mt-8">
            ...
            <p>At checkout, you can choose from the following payment options:</p>
            ...
            <p>Your security is our top priority. All transactions are encrypted with SSL technology. We do not store your credit card information on our servers. All payments are processed through a certified payment provider to ensure the highest level of security.</p>

            <h2 className="mt-8 text-2xl font-bold">Invoice and Billing</h2>
            <p>You will receive an invoice for your order by email as soon as your order is shipped. If you have any questions about your invoice, please contact our customer service.</p>
          </div>
        </div>
      </main>
      <Footer />
