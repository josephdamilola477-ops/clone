        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/withdrawal" className="text-sm hover:text-primary">Withdrawal</Link></li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center text-sm">
            <div className="flex flex-col md:flex-row items-center gap-x-6 gap-y-4 text-xs text-muted-foreground order-2 md:order-1 mt-8 md:mt-0">
                ...
                <div className="flex flex-wrap justify-center gap-x-4">
                    ...
                    <Link href="/terms-and-conditions" className="hover:text-primary">T&C</Link>
            ...
            <div className="flex items-center gap-x-4 order-1 md:order-2">
                ...
                <Button variant="ghost" size="sm" className="gap-2 text-xs">
                    United States (USD $) <ChevronDown size={16} />
                </Button>
            </div>
          </div>
