      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center">
          ...
          <nav className="hidden md:flex flex-1 justify-center items-center space-x-8">
            <Link href="#products" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors">Produkte</Link>
            <Link href="#solutions" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors">Lösungen</Link>
              ...
              <SheetContent side="left" className="bg-background p-0">
                <div className="flex flex-col h-full">
                  ...
                  <nav className="flex-1 flex flex-col gap-4 p-4">
                    <Link href="#products" className="text-lg font-medium" onClick={() => setMobileMenuOpen(false)}>Produkte</Link>
                    <Link href="#solutions" className="text-lg font-medium" onClick={() => setMobileMenuOpen(false)}>Lösungen</Link>
